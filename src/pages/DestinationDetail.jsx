      ...
      {packages.length > 0 && (
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {packages.map((pkg) => (
              <Link to={`/packages/${pkg.slug}`} key={pkg._id} className="bg-surface-container-lowest rounded-xl overflow-hidden editorial-shadow transition-all hover:shadow-2xl block" style={{ textDecoration: 'none', color: 'inherit' }}>
                ...
                <div className="p-6">
                  ...
                  <div className="flex justify-between items-center pt-4 border-t border-slate-100">
                    ...
                    <span className="text-primary font-bold text-sm uppercase tracking-widest hover:underline">
                      Details
                    </span>
                  </div>
                  <a
